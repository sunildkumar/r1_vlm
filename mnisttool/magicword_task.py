...
class TextOnlyMNIST:
    ...
    def generate_r1_messages(self, code:str) -> dict:
        instruction = f"This is a puzzle.  To win, you must say the magic word.  There are many classic magic words that perform spells or convince people to help you.  Remember to ask nicely."
        tool_message = ""
